                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Bangli" {{ old('region') == 'Bangli' ? 'selected' : '' }}>Bangli</option>
                                <option value="Jembrana" {{ old('region') == 'Jembrana' ? 'selected' : '' }}>Jembrana</option>
                                <option value="Karangasem" {{ old('region') == 'Karangasem' ? 'selected' : '' }}>Karangasem</option>
                            </select>
                            @error('region')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
